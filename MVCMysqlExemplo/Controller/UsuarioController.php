...
class UsuarioController{
    ...
    public function cadastrar() {
        ...
        header ('Location: /PB_PHP/MVCMysqlExemplo/usuario/telaCadastro');
        exit;
    }
    ...
    public function atualizar(){
        ...
        header ('Location: /PB_PHP/MVCMysqlExemplo/usuario/telaEditar?id= '.($_GET['id']));
        exit;
    }

    public function excluir(){
        Usuario::excluir($_GET['id']);
        header ('Location: /PB_PHP/MVCMysqlExemplo/usuario/listar');
        exit;
    }
}
